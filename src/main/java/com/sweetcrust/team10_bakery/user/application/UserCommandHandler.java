  ...
  public User registerUser(AddUserCommand addUserCommand) {
    ...
    try {
      ...
      throw new UserServiceException(
          "role",
          "invalid role: " + addUserCommand.role() + " available roles: ADMIN, BAKER, CUSTOMER");
    }

    User user = new User(addUserCommand.username(), hashedPassword, addUserCommand.email(), role);
