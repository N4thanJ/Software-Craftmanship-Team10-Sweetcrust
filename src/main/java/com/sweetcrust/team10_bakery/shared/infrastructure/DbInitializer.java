...
public class DbInitializer {
    ...
    public DbInitializer(
            ...
            DiscountPolicy b2bDiscountPolicy,
            PlatformTransactionManager transactionManager,
            InventoryItemRepository inventoryItemRepository,
            DiscountCodeRegistry discountCodeRegistry,
    ...
    public void init() {
        ...
        ProductCategory donuts =
                new ProductCategory("Donuts", "Round perfection with a hole lotta love");
        ...
        categoryRepository.saveAll(
                List.of(cakes, pastries, donuts, cookies, bread, cupcakes, pies, muffins));

        Product chocolateLavaCake =
                new Product(
                        ...
                        true,
                        cakes.getCategoryId());
        ProductVariant miniChocolateLavaCake =
                new ProductVariant(
                        ProductSize.MINI,
                        "Chocolate Lava Mini",
                        BigDecimal.valueOf(0.0),
                        chocolateLavaCake.getProductId());
        miniChocolateLavaCake.setProduct(chocolateLavaCake);
        ProductVariant regularChocolateLavaCake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Chocolate Lava Regular",
                        BigDecimal.valueOf(0.5),
                        chocolateLavaCake.getProductId());
        regularChocolateLavaCake.setProduct(chocolateLavaCake);
        ProductVariant largeChocolateLavaCake =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Chocolate Lava Large",
        ...
        Product redVelvetCake =
                new Product(
                        ...
                        true,
                        cakes.getCategoryId());
        ProductVariant miniRedVelvetCake =
                new ProductVariant(
                        ProductSize.MINI,
                        "Red Velvet Mini",
                        BigDecimal.valueOf(0.0),
                        redVelvetCake.getProductId());
        miniRedVelvetCake.setProduct(redVelvetCake);
        ProductVariant regularRedVelvetCake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Red Velvet Regular",
                        BigDecimal.valueOf(0.5),
        ...
        ProductVariant largeRedVelvetCake =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Red Velvet Large",
                        BigDecimal.valueOf(0.7),
        ...
        Product carrotCake =
                new Product(
                        ...
                        true,
                        cakes.getCategoryId());
        ProductVariant miniCarrotCake =
                new ProductVariant(
                        ProductSize.MINI,
                        "Carrot Cake Mini",
                        BigDecimal.valueOf(0.0),
                        carrotCake.getProductId());
        miniCarrotCake.setProduct(carrotCake);
        ProductVariant regularCarrotCake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Carrot Cake Regular",
                        BigDecimal.valueOf(0.5),
        ...
        ProductVariant largeCarrotCake =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Carrot Cake Large",
                        BigDecimal.valueOf(0.7),
        ...
        Product tiramisu =
                new Product(
                        ...
                        true,
                        cakes.getCategoryId());
        ProductVariant miniTiramisu =
                new ProductVariant(
                        ProductSize.MINI, "Tiramisu Mini", BigDecimal.valueOf(0.0), tiramisu.getProductId());
        miniTiramisu.setProduct(tiramisu);
        ProductVariant regularTiramisu =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Tiramisu Regular",
                        BigDecimal.valueOf(0.5),
        ...
        ProductVariant largeTiramisu =
                new ProductVariant(
                        ProductSize.LARGE, "Tiramisu Large", BigDecimal.valueOf(0.7), tiramisu.getProductId());
        ...
        ProductVariant miniCroissant =
                new ProductVariant(
                        ProductSize.MINI, "Croissant Mini", BigDecimal.valueOf(0.0), croissant.getProductId());
        miniCroissant.setProduct(croissant);
        ProductVariant regularCroissant =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Croissant Regular",
                        BigDecimal.valueOf(0.5),
                        croissant.getProductId());
        regularCroissant.setProduct(croissant);
        ProductVariant largeCroissant =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Croissant Large",
                        BigDecimal.valueOf(0.7),
        ...
        Product painAuChocolat =
                new Product(
                        ...
                        true,
                        pastries.getCategoryId());
        ProductVariant regularPainAuChocolat =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Pain au Chocolat Regular",
                        BigDecimal.valueOf(0.5),
                        painAuChocolat.getProductId());
        ...
        Product appleTurnover =
                new Product(
                        ...
                        true,
                        pastries.getCategoryId());
        ProductVariant regularAppleTurnover =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Apple Turnover Regular",
                        BigDecimal.valueOf(0.5),
                        appleTurnover.getProductId());
        ...
        ProductVariant regularGlazedDonut =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Glazed Donut Regular",
                        BigDecimal.valueOf(0.5),
                        glazedDonut.getProductId());
        ...
        Product bostonCreamDonut =
                new Product(
                        ...
                        true,
                        donuts.getCategoryId());
        ProductVariant regularBostonCreamDonut =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Boston Cream Donut Regular",
                        BigDecimal.valueOf(0.5),
        ...
        Product sprinkleDonut =
                new Product(
                        ...
                        true,
                        donuts.getCategoryId());
        ProductVariant regularSprinkleDonut =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Sprinkle Donut Regular",
                        BigDecimal.valueOf(0.5),
                        sprinkleDonut.getProductId());
        ...
        ProductVariant regularChocolateChipCookie =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Chocolate Chip Cookie Regular",
                        BigDecimal.valueOf(0.5),
        ...
        Product macadamiaCookie =
                new Product(
                        ...
                        true,
                        cookies.getCategoryId());
        ProductVariant regularMacadamiaCookie =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Macadamia Cookie Regular",
                        BigDecimal.valueOf(0.5),
                        macadamiaCookie.getProductId());
        ...
        Product oatmealRaisinCookie =
                new Product(
                        ...
                        true,
                        cookies.getCategoryId());
        ProductVariant regularOatmealRaisinCookie =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Oatmeal Cookie Regular",
                        BigDecimal.valueOf(0.5),
                        oatmealRaisinCookie.getProductId());
        ...
        Product sugarCookie =
                new Product(
                        ...
                        true,
                        cookies.getCategoryId());
        ProductVariant miniSugarCookie =
                new ProductVariant(
                        ProductSize.MINI,
                        "Sugar Cookie Mini",
                        BigDecimal.valueOf(0.0),
                        sugarCookie.getProductId());
        ...
        Product sourdoughBread =
                new Product(
                        ...
                        true,
                        bread.getCategoryId());
        ProductVariant largeSourdoughBread =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Sourdough Large",
                        BigDecimal.valueOf(0.7),
                        sourdoughBread.getProductId());
        ...
        Product baguette =
                new Product(
                        ...
                        true,
                        bread.getCategoryId());
        ProductVariant largeBaguette =
                new ProductVariant(
                        ProductSize.LARGE, "Baguette Large", BigDecimal.valueOf(0.7), baguette.getProductId());
        largeBaguette.setProduct(baguette);
        productRepository.save(baguette);
        productVariantRepository.save(largeBaguette);

        Product cinnamonBread =
                new Product(
                        ...
                        true,
                        bread.getCategoryId());
        ProductVariant regularCinnamonBread =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Cinnamon Bread Regular",
                        BigDecimal.valueOf(0.5),
                        cinnamonBread.getProductId());
        ...
        ProductVariant regularVanillaCupcake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Vanilla Cupcake Regular",
                        BigDecimal.valueOf(0.5),
                        vanillaCupcake.getProductId());
        ...
        Product chocolateCupcake =
                new Product(
                        ...
                        true,
                        cupcakes.getCategoryId());
        ProductVariant regularChocolateCupcake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Chocolate Cupcake Regular",
                        BigDecimal.valueOf(0.5),
                        chocolateCupcake.getProductId());
        ...
        Product lemonCupcake =
                new Product(
                        ...
                        true,
                        cupcakes.getCategoryId());
        ProductVariant regularLemonCupcake =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Lemon Cupcake Regular",
                        BigDecimal.valueOf(0.5),
                        lemonCupcake.getProductId());
        ...
        Product redVelvetCupcake =
                new Product(
                        ...
                        true,
                        cupcakes.getCategoryId());
        ProductVariant miniRedVelvetCupcake =
                new ProductVariant(
                        ProductSize.MINI,
                        "Red Velvet Cupcake Mini",
                        BigDecimal.valueOf(0.0),
                        redVelvetCupcake.getProductId());
        ...
        Product applePie =
                new Product(
                        ...
                        true,
                        pies.getCategoryId());
        ProductVariant largeApplePie =
                new ProductVariant(
                        ProductSize.LARGE, "Apple Pie Large", BigDecimal.valueOf(0.7), applePie.getProductId());
        ...
        Product pumpkinPie =
                new Product(
                        ...
                        true,
                        pies.getCategoryId());
        ProductVariant largePumpkinPie =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Pumpkin Pie Large",
                        BigDecimal.valueOf(0.7),
                        pumpkinPie.getProductId());
        ...
        Product cherryPie =
                new Product(
                        ...
                        true,
                        pies.getCategoryId());
        ProductVariant largeCherryPie =
                new ProductVariant(
                        ProductSize.LARGE,
                        "Cherry Pie Large",
                        BigDecimal.valueOf(0.7),
                        cherryPie.getProductId());
        ...
        ProductVariant regularBlueberryMuffin =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Blueberry Muffin Regular",
                        BigDecimal.valueOf(0.5),
                        blueberryMuffin.getProductId());
        ...
        Product bananaMuffin =
                new Product(
                        ...
                        true,
                        muffins.getCategoryId());
        ProductVariant regularBananaMuffin =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Banana Muffin Regular",
                        BigDecimal.valueOf(0.5),
                        bananaMuffin.getProductId());
        ...
        Product chocolateChipMuffin =
                new Product(
                        ...
                        true,
                        muffins.getCategoryId());
        ProductVariant regularChocolateChipMuffin =
                new ProductVariant(
                        ProductSize.REGULAR,
                        "Chocolate Chip Muffin Regular",
                        BigDecimal.valueOf(0.5),
        ...
        // Customers
        User donutDan =
                new User("DonutDan", "Glazed4Life!", "donut.dan@sweetcrust.com", UserRole.CUSTOMER);
        User muffinMary =
                new User("MuffinMary", "BlueberryBurst1!", "muffin.mary@sweetcrust.com", UserRole.CUSTOMER);
        User croissantCarl =
                new User(
                        "CroissantCarl",
                        "FlakeyGoodness7!",
                        "croissant.carl@sweetcrust.com",
                        UserRole.CUSTOMER);
        User cupcakeClaire =
                new User(
                        "CupcakeClaire", "Sprinkles2024!", "cupcake.claire@sweetcrust.com", UserRole.CUSTOMER);
        User piePatrick =
                new User("PiePatrick", "ApplePie4Ever!", "pie.patrick@sweetcrust.com", UserRole.CUSTOMER);
        User cookieConnie =
                new User("CookieConnie", "ChocChip123!", "cookie.connie@sweetcrust.com", UserRole.CUSTOMER);
        User breadBob =
                new User("BreadBob", "Sourdough99!", "bread.bob@sweetcrust.com", UserRole.CUSTOMER);
        User cakeCathy =
                new User("CakeCathy", "RedVelvet5!", "cake.cathy@sweetcrust.com", UserRole.CUSTOMER);
        User eclaireEllie =
                new User("EclaireEllie", "CreamPuff88!", "eclair.ellie@sweetcrust.com", UserRole.CUSTOMER);
        User brownieBrenda =
                new User(
                        "BrownieBrenda", "Fudge4Days!", "brownie.brenda@sweetcrust.com", UserRole.CUSTOMER);

        // Baker
        User bakerBill =
                new User("BakerBill", "KneadTheDough1!", "baker.bill@sweetcrust.com", UserRole.BAKER);
        User bakerBetty =
                new User("BakerBetty", "RiseAndShine2!", "baker.betty@sweetcrust.com", UserRole.BAKER);
        User bakerBenny =
                new User("BakerBenny", "ProofingPro3!", "baker.benny@sweetcrust.com", UserRole.BAKER);
        User bakerBella =
                new User("BakerBella", "YeastMode4!", "baker.bella@sweetcrust.com", UserRole.BAKER);

        // Admin
        User adminAlice =
                new User("AdminAlice", "SuperAdmin99!", "admin.alice@sweetcrust.com", UserRole.ADMIN);
        User adminAlex =
                new User("AdminAlex", "BossMode2024!", "admin.alex@sweetcrust.com", UserRole.ADMIN);
        ...
        InventoryItem parisInventory =
                new InventoryItem(parisShop.getShopId(), largeApplePie.getVariantId());
        InventoryItem tokyoInventory =
                new InventoryItem(tokyoShop.getShopId(), miniCroissant.getVariantId());
        InventoryItem newYorkInventory =
                new InventoryItem(newYorkShop.getShopId(), regularChocolateCupcake.getVariantId());
        InventoryItem londonInventory =
                new InventoryItem(londonShop.getShopId(), regularGlazedDonut.getVariantId());
        InventoryItem berlinInventory =
                new InventoryItem(berlinShop.getShopId(), regularChocolateChipCookie.getVariantId());
        InventoryItem romeInventory =
                new InventoryItem(romeShop.getShopId(), largeTiramisu.getVariantId());
        InventoryItem barcelonaInventory =
                new InventoryItem(barcelonaShop.getShopId(), regularBlueberryMuffin.getVariantId());
        InventoryItem amsterdamInventory =
                new InventoryItem(amsterdamShop.getShopId(), largePumpkinPie.getVariantId());
        ...
        cartItemRepository.save(CartItem.fromVariant(donutCart.getCartId(), regularGlazedDonut, 2));
        cartItemRepository.save(CartItem.fromVariant(donutCart.getCartId(), regularBostonCreamDonut, 5));
        cartItemRepository.save(CartItem.fromVariant(donutCart.getCartId(), regularMapleDonut, 3));
        donutCart.setOwnerId(donutDan.getUserId());

        Cart cupcakeCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(cupcakeCart.getCartId(), regularChocolateCupcake, 10));
        cartItemRepository.save(CartItem.fromVariant(cupcakeCart.getCartId(), regularLemonCupcake, 5));
        cupcakeCart.setOwnerId(cupcakeClaire.getUserId());

        Cart pieCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(pieCart.getCartId(), largeApplePie, 1));
        cartItemRepository.save(CartItem.fromVariant(pieCart.getCartId(), largeApplePie, 2));
        pieCart.setOwnerId(piePatrick.getUserId());

        Cart cookieCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(cookieCart.getCartId(), regularChocolateChipCookie, 20));
        cartItemRepository.save(CartItem.fromVariant(cookieCart.getCartId(), regularMacadamiaCookie, 5));
        cookieCart.setOwnerId(cookieConnie.getUserId());

        Cart cakeCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(cakeCart.getCartId(), largeRedVelvetCake, 2));
        cartItemRepository.save(CartItem.fromVariant(cakeCart.getCartId(), largeChocolateLavaCake, 5));
        cakeCart.setOwnerId(cakeCathy.getUserId());

        Cart breadCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(breadCart.getCartId(), largeSourdoughBread, 2));
        cartItemRepository.save(CartItem.fromVariant(breadCart.getCartId(), largeBaguette, 5));
        breadCart.setOwnerId(breadBob.getUserId());

        Cart croissantCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(croissantCart.getCartId(), largeCroissant, 7));
        cartItemRepository.save(CartItem.fromVariant(croissantCart.getCartId(), largeTiramisu, 10));
        croissantCart.setOwnerId(croissantCarl.getUserId());

        Cart muffinCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(muffinCart.getCartId(), regularBananaMuffin, 4));
        cartItemRepository.save(CartItem.fromVariant(muffinCart.getCartId(), regularBlueberryMuffin, 10));
        cartItemRepository.save(CartItem.fromVariant(muffinCart.getCartId(), regularChocolateChipMuffin, 3));
        ...
        Order donutOrder =
                Order.createB2C(
                        Address.builder()
                                .setStreet("Donut Drive 15")
                                .setCity("Glazeville")
                                .setPostalCode("12345")
                                .setCountry("Donutland")
                                .build(),
                        LocalDateTime.now().plusDays(1),
                        donutDan.getUserId(),
                        donutCart.getCartId(),
        ...
        cartItemRepository.save(CartItem.fromVariant(parisToLondonCart.getCartId(), regularCarrotCake, 10));
        cartItemRepository.save(CartItem.fromVariant(parisToLondonCart.getCartId(), miniCroissant, 50));
        cartItemRepository.save(CartItem.fromVariant(parisToLondonCart.getCartId(), regularCinnamonBread, 15));
        parisToLondonCart.setOwnerId(bakerBenny.getUserId());

        Cart tokyoToNewYorkCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(tokyoToNewYorkCart.getCartId(), miniCroissant, 50));
        cartItemRepository.save(CartItem.fromVariant(tokyoToNewYorkCart.getCartId(), miniSugarCookie, 15));
        tokyoToNewYorkCart.setOwnerId(bakerBenny.getUserId());

        Cart romeToBarcelonaCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(romeToBarcelonaCart.getCartId(), miniCroissant, 50));
        cartItemRepository.save(CartItem.fromVariant(romeToBarcelonaCart.getCartId(), largeTiramisu, 100));
        romeToBarcelonaCart.setOwnerId(bakerBella.getUserId());

        Cart berlinToAmsterdamCart = new Cart();
        cartItemRepository.save(CartItem.fromVariant(berlinToAmsterdamCart.getCartId(), miniRedVelvetCake, 10));
        cartItemRepository.save(CartItem.fromVariant(berlinToAmsterdamCart.getCartId(), largePumpkinPie, 20));
        ...
        transactionTemplate.execute(
                status -> {
                    Function<Cart, BigDecimal> computeSubtotal =
                            cart ->
                                    cartItemRepository.findByCartId(cart.getCartId()).stream()
                                            .map(
                                                    item ->
                                                            item.getUnitPrice().multiply(BigDecimal.valueOf(item.getQuantity())))
                                            .reduce(BigDecimal.ZERO, BigDecimal::add);

                    DiscountCodePolicy sweetcrust = discountCodeRegistry.getByCode("SWEETCRUST10");
                    DiscountCodePolicy noDiscount = discountCodeRegistry.getByCode(null);

                    Cart cartForCupcake =
                            cartRepository
                                    .findById(cupcakeCart.getCartId())
                                    .orElseThrow(() -> new RuntimeException("Cart not found for cupcake order"));
                    BigDecimal cupcakeSubtotal = computeSubtotal.apply(cartForCupcake);
                    BigDecimal cupcakeTotalAfterDiscount = sweetcrust.applyDiscount(cupcakeSubtotal);
                    ...
                    Cart cartForPie =
                            cartRepository
                                    .findById(pieCart.getCartId())
                                    .orElseThrow(() -> new RuntimeException("Cart not found for pie order"));
                    BigDecimal pieSubtotal = computeSubtotal.apply(cartForPie);
                    DiscountCodePolicy happy = discountCodeRegistry.getByCode("HAPPYNEWYEAR50");
                    BigDecimal pieTotalAfter = happy.applyDiscount(pieSubtotal);
                    ...
                    Cart cartForCookie =
                            cartRepository
                                    .findById(cookieCart.getCartId())
                                    .orElseThrow(() -> new RuntimeException("Cart not found for cookie order"));
                    BigDecimal cookieSubtotal = computeSubtotal.apply(cartForCookie);
                    DiscountCodePolicy expiredPolicy = discountCodeRegistry.getByCode("EXPIRED20");
                    BigDecimal cookieTotalAfter = expiredPolicy.applyDiscount(cookieSubtotal);
                    ...
                    Cart cartForParis =
                            cartRepository
                                    .findById(parisToLondon.getCartId())
                                    .orElseThrow(
                                            () -> new RuntimeException("Cart not found for Paris->London order"));
                    BigDecimal parisSubtotal = cartItemRepository.findByCartId(cartForParis.getCartId()).stream()
                    ...
                    Cart cartForTokyo =
                            cartRepository
                                    .findById(tokyoToNewYork.getCartId())
                                    .orElseThrow(
                                            () -> new IllegalStateException("Cart not found for Tokyo->NewYork order"));
                    BigDecimal tokyoSubtotal =
                            cartItemRepository.findByCartId(cartForTokyo.getCartId()).stream()
                                    .map(item -> item.getUnitPrice().multiply(BigDecimal.valueOf(item.getQuantity())))
                                    .reduce(BigDecimal.ZERO, BigDecimal::add);
                    ...
                    Cart cartForRome =
                            cartRepository
                                    .findById(romeToBarcelona.getCartId())
                                    .orElseThrow(
                                            () -> new IllegalStateException("Cart not found for Rome->Barcelona order"));
                    BigDecimal romeSubtotal =
                            cartItemRepository.findByCartId(cartForRome.getCartId()).stream()
                                    .map(item -> item.getUnitPrice().multiply(BigDecimal.valueOf(item.getQuantity())))
                                    .reduce(BigDecimal.ZERO, BigDecimal::add);
                    ...
                    Cart cartForBerlin =
                            cartRepository
                                    .findById(berlinToAmsterdam.getCartId())
                                    .orElseThrow(
                                            () ->
                                                    new IllegalStateException("Cart not found for Berlin->Amsterdam order"));
                    BigDecimal berlinSubtotal =
                            cartItemRepository.findByCartId(cartForBerlin.getCartId()).stream()
                                    .map(item -> item.getUnitPrice().multiply(BigDecimal.valueOf(item.getQuantity())))
                                    .reduce(BigDecimal.ZERO, BigDecimal::add);
                    ...
                    List<Order> b2cOrders =
                            List.of(cakeOrder, breadOrder, croissantOrder, donutOrder, muffinOrder);
                    for (Order o : b2cOrders) {
                        Cart cart =
                                cartRepository
                                        .findById(o.getCartId())
                                        .orElseThrow(
                                                () -> new RuntimeException("Cart not found for order " + o.getOrderId()));
                        BigDecimal subtotal = computeSubtotal.apply(cart);
                        BigDecimal totalAfter = noDiscount.applyDiscount(subtotal);
