...
public class DbInitializer {
  ...
  public void init() {
    ...
    cartItemRepository.save(
        CartItem.fromVariant(donutCart.getCartId(), regularBostonCreamDonut, 5));
    ...
    cartItemRepository.save(
        CartItem.fromVariant(cupcakeCart.getCartId(), regularChocolateCupcake, 10));
    ...
    cartItemRepository.save(
        CartItem.fromVariant(cookieCart.getCartId(), regularChocolateChipCookie, 20));
    cartItemRepository.save(
        CartItem.fromVariant(cookieCart.getCartId(), regularMacadamiaCookie, 5));
    ...
    cartItemRepository.save(
        CartItem.fromVariant(muffinCart.getCartId(), regularBlueberryMuffin, 10));
    cartItemRepository.save(
        CartItem.fromVariant(muffinCart.getCartId(), regularChocolateChipMuffin, 3));
    ...
    cartItemRepository.save(
        CartItem.fromVariant(parisToLondonCart.getCartId(), regularCarrotCake, 10));
    cartItemRepository.save(CartItem.fromVariant(parisToLondonCart.getCartId(), miniCroissant, 50));
    cartItemRepository.save(
        CartItem.fromVariant(parisToLondonCart.getCartId(), regularCinnamonBread, 15));
    parisToLondonCart.setOwnerId(bakerBenny.getUserId());

    Cart tokyoToNewYorkCart = new Cart();
    cartItemRepository.save(
        CartItem.fromVariant(tokyoToNewYorkCart.getCartId(), miniCroissant, 50));
    cartItemRepository.save(
        CartItem.fromVariant(tokyoToNewYorkCart.getCartId(), miniSugarCookie, 15));
    tokyoToNewYorkCart.setOwnerId(bakerBenny.getUserId());

    Cart romeToBarcelonaCart = new Cart();
    cartItemRepository.save(
        CartItem.fromVariant(romeToBarcelonaCart.getCartId(), miniCroissant, 50));
    cartItemRepository.save(
        CartItem.fromVariant(romeToBarcelonaCart.getCartId(), largeTiramisu, 100));
    romeToBarcelonaCart.setOwnerId(bakerBella.getUserId());

    Cart berlinToAmsterdamCart = new Cart();
    cartItemRepository.save(
        CartItem.fromVariant(berlinToAmsterdamCart.getCartId(), miniRedVelvetCake, 10));
    cartItemRepository.save(
        CartItem.fromVariant(berlinToAmsterdamCart.getCartId(), largePumpkinPie, 20));
    ...
    transactionTemplate.execute(
        status -> {
          ...
          BigDecimal parisSubtotal =
              cartItemRepository.findByCartId(cartForParis.getCartId()).stream()
