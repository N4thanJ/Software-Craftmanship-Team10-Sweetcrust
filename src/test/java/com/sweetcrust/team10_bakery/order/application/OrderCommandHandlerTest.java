...
public class OrderCommandHandlerTest {
  ...
  @Mock private DiscountCodePolicy discountCodePolicy;

  @Mock private DiscountPolicy discountPolicy;

  @Mock private DiscountCodeRegistry discountCodeRegistry;

  @Mock private OrderEventPublisher orderEventPublisher;

  @InjectMocks private OrderCommandHandler orderCommandHandler;
  ...
  void givenValidData_whenCreateB2COrder_thenOrderIsCreated() {
    ...
    CreateB2COrderCommand command =
        new CreateB2COrderCommand(address, futureDate, customerId, cartId, discountCode);
  ...
  void givenNullDeliveryDate_whenCreateB2COrder_thenExceptionIsThrown() {
    ...
    String discountCode = "SWEETCRUST20";
    CreateB2COrderCommand command =
        new CreateB2COrderCommand(address, null, new UserId(), new CartId(), discountCode);

    // when
    OrderServiceException exception =
        assertThrows(
            OrderServiceException.class, () -> orderCommandHandler.createB2COrder(command));
  ...
  void givenPastDeliveryDate_whenCreateB2COrder_thenExceptionIsThrown() {
    ...
    String discountCode = "SWEETCRUST20";
    CreateB2COrderCommand command =
        new CreateB2COrderCommand(address, pastDate, new UserId(), new CartId(), discountCode);
  ...
  void givenNonExistentCustomer_whenCreateB2COrder_thenExceptionIsThrown() {
    ...
    String discountCode = "SWEETCRUST20";
    CreateB2COrderCommand command =
        new CreateB2COrderCommand(address, futureDate, customerId, new CartId(), discountCode);
  ...
  void givenBakerRole_whenCreateB2COrder_thenExceptionIsThrown() {
    ...
    CreateB2COrderCommand command =
        new CreateB2COrderCommand(address, futureDate, bakerId, cartId, discountCode);
  ...
  void givenValidData_whenCreateB2BOrder_thenOrderIsCreated() {
    ...
    CreateB2BOrderCommand command =
        new CreateB2BOrderCommand(futureDate, orderingShopId, sourceShopId, bakerId, cartId);
  ...
  void givenPastDeliveryDate_whenCreateB2BOrder_thenExceptionIsThrown() {
    ...
    CreateB2BOrderCommand command =
        new CreateB2BOrderCommand(pastDate, new ShopId(), new ShopId(), new UserId(), new CartId());

    // when
    OrderServiceException exception =
        assertThrows(
            OrderServiceException.class, () -> orderCommandHandler.createB2BOrder(command));
  ...
  void givenNonExistentShop_whenCreateB2BOrder_thenExceptionIsThrown() {
    ...
    CreateB2BOrderCommand command =
        new CreateB2BOrderCommand(
            futureDate, nonExistentShopId, new ShopId(), new UserId(), new CartId());
  ...
  void givenNonExistentUser_whenCreateB2BOrder_thenExceptionIsThrown() {
    ...
    CreateB2BOrderCommand command =
        new CreateB2BOrderCommand(
            futureDate, orderingShopId, sourceShopId, nonExistentUserId, cartId);
  ...
  void givenCustomerRole_whenCreateB2BOrder_thenExceptionIsThrown() {
    ...
    CreateB2BOrderCommand command =
        new CreateB2BOrderCommand(futureDate, orderingShopId, sourceShopId, customerId, cartId);
